...
public class ChangeToFrenchTest {
    ...
    public void changeToFrench() {
        ...
        // Action: Click on Français at the top bar
        // Action: Click the text Français at the top bar
        ...
        assertThat(driver.getTitle(), is("Le journal Nhân Dân"));
    }
}
