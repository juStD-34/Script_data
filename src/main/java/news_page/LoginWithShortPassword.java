...
public class LoginWithShortPassword {
    ...
    public void logintest() throws InterruptedException, UnhandledAlertException {
        ...
        // Action: Enter "abc" into password field
        driver.findElement(By.id("txtLoginPassword")).sendKeys("abc");
        // Action: Press ENTER
        driver.findElement(By.id("txtLoginPassword")).sendKeys(Keys.ENTER);
        Thread.sleep(2000);
        Alert alert = driver.switchTo().alert();
        String errorMgs = driver.switchTo().alert().getText();
        Assert.assertEquals("Bạn vui lòng nhập mật khẩu dài từ 6 ký tự trở lên!", errorMgs);
